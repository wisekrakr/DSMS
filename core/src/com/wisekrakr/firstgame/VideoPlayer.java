...
public interface VideoPlayer extends Disposable {
     ...
     * Normal usecase is to start rendering after {@link ()} returns true.
     *
     ...
     * video. If this callback has not been set, a good alternative is to wait until the {@link } function
