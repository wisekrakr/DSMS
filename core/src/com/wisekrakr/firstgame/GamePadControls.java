...
public class GamePadControls  {
    ...
    public static final int BUTTON_LT = 8;
    ...
    public static final int AXIS_RIGHT_X = 0; //-1 is left | +1 is right
    public static final int AXIS_RIGHT_Y = 1; //-1 is up | +1 is down
